...
def register_callbacks(app):
    ...
    def render_sub_content_vdc_sesup(sub_tab):
        if sub_tab == 'sub-tab-dmz192':
            ...
            # Calcula o número de hosts físicos e virtuais 
            num_hosts_fisicos_dmz192 = len(df_dmz_192_sesup[df_dmz_192_sesup['Tipo'] == 'Fisico'])
            num_hosts_virtuais_dmz192 = len(df_dmz_192_sesup[df_dmz_192_sesup['Tipo'] == 'Virtual'])
            

            # Cria o gráfico de pizza para a quantidade de hosts com portas abertas e fechadas
            ...
            # Cria o gráfico de pizza para a quantidade de hosts físicos e virtuais
            labels_tipos = ['Físicos', 'Virtuais']
            values_tipos = [num_hosts_fisicos_dmz192, num_hosts_virtuais_dmz192]
            fig_pizza_tipos = go.Figure(data=[go.Pie(labels=labels_tipos, values=values_tipos)])
            ...
            return html.Div([
                ...
                html.Div([
                    dcc.Graph(figure=fig_pizza_tipos, id='grafico-pizza-tipos'),
                ], style={'width': '48%', 'display': 'inline-block'}),
                html.Div([
            ...
            num_hosts_fisicos_dmz141 = len(df_dmz_141_sesup[df_dmz_141_sesup['Tipo'] == 'Fisico'])
            num_hosts_virtuais_dmz141 = len(df_dmz_141_sesup[df_dmz_141_sesup['Tipo'] == 'Virtual'])
            ...
            labels_tipos = ['Físicos', 'Virtuais']
            values_tipos = [num_hosts_fisicos_dmz141, num_hosts_virtuais_dmz141]
            fig_pizza_tipos = go.Figure(data=[go.Pie(labels=labels_tipos, values=values_tipos)])
            ...
            num_hosts_fisicos_pesquisa = len(df_pesquisa_sesup[df_pesquisa_sesup['Tipo'] == 'Fisico'])
            num_hosts_virtuais_pesquisa = len(df_pesquisa_sesup[df_pesquisa_sesup['Tipo'] == 'Virtual'])
            ...
            labels_tipos = ['Físicos', 'Virtuais']
            values_tipos = [num_hosts_fisicos_pesquisa, num_hosts_virtuais_pesquisa]
            fig_pizza_tipos = go.Figure(data=[go.Pie(labels=labels_tipos, values=values_tipos)])
            ...
            num_hosts_fisicos_operacional = len(df_operacional_sesup[df_operacional_sesup['Tipo'] == 'Fisico'])
            num_hosts_virtuais_operacional = len(df_operacional_sesup[df_operacional_sesup['Tipo'] == 'Virtual'])
            ...
            labels_tipos = ['Físicos', 'Virtuais']
            values_tipos = [num_hosts_fisicos_operacional, num_hosts_virtuais_operacional]
            fig_pizza_tipos = go.Figure(data=[go.Pie(labels=labels_tipos, values=values_tipos)])

            return html.Div([
                html.Div([
                    dcc.Graph(figure=fig_pizza_operacional, id='grafico-pizza-portas'),
                ], style={'width': '48%', 'display': 'inline-block'}),
                html.Div([
                    dcc.Graph(figure=fig_pizza_tipos, id='grafico-pizza-tipos'),
                ], style={'width': '48%', 'display': 'inline-block'}),
...
e digitação de texto no campo 'input-filtro-dmz192'
    ...
    def display_table_dmz192(n_clicks1, n_clicks2,  n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-dmz192':
            ...
            titulo = "Hosts com Portas Abertas DMZ REDE-192 SESUP"
    ...
    def display_table_dmz141(n_clicks1, n_clicks2,  n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-dmz141':
            ...
            titulo = "Hosts com Portas Abertas DMZ REDE-141 SESUP"
    ...
    def display_table_pesquisa(n_clicks1, n_clicks2, n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-pesquisa':
            ...
            titulo = "Hosts com Portas Abertas PESQUISA SESUP"
    ...
    def display_table_operacional(n_clicks1, n_clicks2, n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-operacional':
            ...
            titulo = "Hosts com Portas Abertas OPERACIONAL SESUP"
    ...
    def render_sub_content_vdc_coids(sub_tab):
        if sub_tab == 'sub-tab-dmz':
            ...
            num_hosts_fisicos_dmz = len(df_dmz_coids[df_dmz_coids['Tipo'] == 'Fisico'])
            num_hosts_virtuais_dmz = len(df_dmz_coids[df_dmz_coids['Tipo'] == 'Virtual'])
            ...
            labels_tipos = ['Físicos', 'Virtuais']
            values_tipos = [num_hosts_fisicos_dmz, num_hosts_virtuais_dmz]
            fig_pizza_tipos = go.Figure(data=[go.Pie(labels=labels_tipos, values=values_tipos)])
            ...
            num_hosts_fisicos_pesquisa = len(df_pesquisa_coids[df_pesquisa_coids['Tipo'] == 'Fisico'])
            num_hosts_virtuais_pesquisa = len(df_pesquisa_coids[df_pesquisa_coids['Tipo'] == 'Virtual'])
            ...
            num_hosts_fisicos_operacional = len(df_operacional_coids[df_operacional_coids['Tipo'] == 'Fisico'])
            num_hosts_virtuais_operacional = len(df_operacional_coids[df_operacional_coids['Tipo'] == 'Virtual'])
    ...
    def display_table_dmz(n_clicks1, n_clicks2, n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-dmz':
            ...
            titulo = "Hosts com Portas Abertas DMZ COIDS"
    ...
    def display_table_pesquisa(n_clicks1, n_clicks2, n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-pesquisa':
            ...
            titulo = "Hosts com Portas Abertas PESQUISA COIDS"
        elif button_id == 'botao-tabela2-pesquisa':
            filtered_data = df_pesquisa_coids[df_pesquisa_coids['Portas abertas'] == 'Nenhuma porta aberta encontrada']
    ...
    def display_table_operacional(n_clicks1, n_clicks2, n_clicks3, filtro_host):
        ...
        if button_id == 'botao-tabela1-operacional':
            ...
            titulo = "Hosts com Portas Abertas OPERACIONAL COIDS"
        elif button_id == 'botao-tabela2-operacional':
            filtered_data = df_operacional_coids[df_operacional_coids['Portas abertas'] == 'Nenhuma porta aberta encontrada']
